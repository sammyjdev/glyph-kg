...
def test_from_graph_file_loads_and_serves(tmp_path: Path) -> None:
    ...
    pack = source.context("goblin resists fire")
    assert isinstance(pack, ContextPack)
